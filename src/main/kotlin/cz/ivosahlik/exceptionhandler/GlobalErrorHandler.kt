...
import cz.ivosahlik.exception.InstructorNotValidException
import mu.KLogging
...
class GlobalErrorHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleInputRequestError(
        ex: InstructorNotValidException,
        request: WebRequest
    ): ResponseEntity<Any> {
    ...
    fun handleAllExceptions(ex: java.lang.Exception,
                            request: WebRequest
    ): ResponseEntity<Any> {
